...
describe("MusicNftMarketPlace", function () {
  ...
  let url = "https://bafybeidumfkrgzgfmgca7bcb6p6x3kzczwyk6xksnwfor3zgkgxr5ydi5m.ipfs.nftstorage.link/"
  ...
  describe("Deployment", function () {
    ...
    it("Should track name, symbol, url, royalty fee and artist", async function () {
      ...
      expect(await nftMarketplace.baseUrl()).to.equal(url);
